    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <li class="breadcrumb-item"><a href="{{route('bills.index')}}">Facturas</a></li>
                <li class="breadcrumb-item active" aria-current="page">Generar una factura</li>
            </ol>
        </nav>
    </div>
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-footer text-muted">
                    <button type="submit" id="guardar" class="btn btn-outline mr-2 float-right">Registrar</button>
                    <a href="{{route('bills.index')}}" class="btn btn-outline-danger">Cancelar</a>
                </div>
            </div>
            {!! Form::close() !!}
        </div>
