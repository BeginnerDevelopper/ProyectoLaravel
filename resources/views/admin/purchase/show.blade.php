                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 text-center">
                            <label class="form-control-label" name="name" id="name" for="name"><strong>Proveedor</strong></label>
                    ...
                    <br /><br />
                    <div class="form-group row ">
                        <h4 class="card-title ml-3">Lista de compras </h4>
                            ...
                            <table id="detalles" class="table">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <p align="right">${{number_format($subtotal*$purchase->tax/100)}}</p>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${{number_format($purchaseDetail->quantity*$purchaseDetail->price)}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
